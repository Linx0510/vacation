...
TRUNCATE TABLE cookies_consent;
...
(1, 2, 'Осенний гастро-фестиваль', 'Большой городской фестиваль еды и музыки.', 2, 'approved', NULL, DATE_ADD(NOW(), INTERVAL 10 DAY), 'Москва, Парк Горького', '/images/static/sample-event-1.jpg', 120, 2, NOW()),
(2, 2, 'Мастер-класс по керамике', 'Создаем кружки и тарелки своими руками.', 3, 'pending', NULL, DATE_ADD(NOW(), INTERVAL 14 DAY), 'Москва, Арт-лофт', '/images/static/sample-event-2.jpg', 20, 0, NOW()),
(3, 2, 'Выездной пикник у озера', 'День отдыха на природе с музыкой и активностями.', 4, 'requires_changes', 'Добавьте подробности по трансферу и программе.', DATE_ADD(NOW(), INTERVAL 21 DAY), 'Подмосковье', '/images/static/sample-event-3.jpg', 50, 0, NOW());
...
(3, 'Мероприятие одобрено', 'Ваше мероприятие «Осенний гастро-фестиваль» прошло модерацию.', 0, NOW()),
(2, 'Новый отзыв', 'Пользователь оставил отзыв о вашем мероприятии.', 0, NOW()),
(3, 'Предложение на голосовании', 'Ваше предложение доступно для голосования.', 0, NOW());
...
(1, 2, 'Вакация Events', 'Организация городских и выездных событий', 1);
